...
def GenerateEmbeddingFeature(SequenceList, EmbeddingList, PaddingLength):   # 产生
    SampleFeature = []
...
#GBDT(Gradient Boosting Decision Tree) Classifier
    GBDT_clf = GradientBoostingClassifier(learning_rate=0.1, n_estimators=20)
