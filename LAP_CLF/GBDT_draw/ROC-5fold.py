...
while counter0 < 5:
    ...
    MyEnlarge(0.13, 0.58, 0.13, 0.2, 0.1, 0.05, 2, mean_fpr, tprs[i], 1.5, colorlist[i])
...
plt.legend(bbox_to_anchor=(0.35, 0.84), fontsize=15)
...
plt.text(0.06, 0.9, s='A', ha='center', **style)
