...
while counter0 < 5:
    ...
    # MyEnlarge(0.05, 0.7, 0.08, 0.13, 0.73, 0.05, 3.2, mean_fpr, tprs[i], 1.5, colorlist[i])
    MyEnlarge(0.05, 0.6, 0.1, 0.2, 0.1, 0.05, 2.2, mean_fpr, tprs[i], 1.5, colorlist[i])
...
# plt.legend(bbox_to_anchor=(0.18, 0.78), fontsize=15)
plt.legend(bbox_to_anchor=(0.33, 0.84), fontsize=15)
...
plt.text(0.05, 0.9, s='A', ha='center', **style)
