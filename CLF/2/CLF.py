...
if __name__ == '__main__':
    ...
    ReadMyCsv1(PositiveSample_Train, 'Positive_Sample_Train2.csv')
    PositiveSample_Validation = []
    ReadMyCsv1(PositiveSample_Validation, 'Positive_Sample_Validation2.csv')
    PositiveSample_Test = []
    ReadMyCsv1(PositiveSample_Test, 'Positive_Sample_Test2.csv')

    NegativeSample_Train = []
    ReadMyCsv1(NegativeSample_Train, 'Negative_Sample_Train2.csv')
    NegativeSample_Validation = []
    ReadMyCsv1(NegativeSample_Validation, 'Negative_Sample_Validation2.csv')
    NegativeSample_Test = []
    ReadMyCsv1(NegativeSample_Test, 'Negative_Sample_Test2.csv')
...
#随机森林
    ...
    # print('CLF', forest.score(X_test,np.array(y_test_Pre)))
    #
    # LR_clf = LogisticRegression()
    # LR_clf.fit(X_train, np.array(y_train_Pre))
    # print('LR_clf', LR_clf.score(X_test, np.array(y_test_Pre)))
    # TestOutput(LR_clf, 'LR_')
    #
    # SVM_clf = svm.SVC(probability = True)
    # SVM_clf.fit(X_train,np.array(y_train_Pre))
    # print('SVM_clf', SVM_clf.score(X_test, np.array(y_test_Pre)))
    # TestOutput(SVM_clf, 'SVM_')
    #
    # KNN_clf = KNeighborsClassifier()
    # KNN_clf.fit(X_train,np.array(y_train_Pre))
    # print('KNN_clf', KNN_clf.score(X_test, np.array(y_test_Pre)))
    ...
    # print('GBDT_clf', GBDT_clf.score(X_test, np.array(y_test_Pre)))
