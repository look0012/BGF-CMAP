...
if __name__ == '__main__':
    ...
    ReadMyCsv1(PositiveSample_Train, 'Positive_Sample_Train4.csv')
    PositiveSample_Validation = []
    ReadMyCsv1(PositiveSample_Validation, 'Positive_Sample_Validation4.csv')
    PositiveSample_Test = []
    ReadMyCsv1(PositiveSample_Test, 'Positive_Sample_Test4.csv')

    NegativeSample_Train = []
    ReadMyCsv1(NegativeSample_Train, 'Negative_Sample_Train4.csv')
    NegativeSample_Validation = []
    ReadMyCsv1(NegativeSample_Validation, 'Negative_Sample_Validation4.csv')
    NegativeSample_Test = []
    ReadMyCsv1(NegativeSample_Test, 'Negative_Sample_Test4.csv')
    ...
    # 保存模型
    joblib.dump(GBDT_clf, r'C:\PyCharm 2021.3.3\PycharmProjects\circRNA-miRNA-91%\step\3\CLF\4\GBDT.pk1')  # 第二个参数只需要写文件名字,是不是比pickle更人性化
